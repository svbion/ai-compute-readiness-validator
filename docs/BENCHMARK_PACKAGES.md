...
gpu-validator benchmark compare --input RUN_A --node-id RUN_B --output-dir artifacts/benchmark-compare
```
...
Do not redistribute compiled NCCL Tests binaries or NVIDIA proprietary binaries. Keep raw/private archives out of public repositories.
