...
PACKAGE = Path(__file__).resolve().parents[2] / "gpu-benchmark-lab" / "benchmarks" / "runpod" / "h200-sxm5" / "5-gpu-nv18" / "2026-07-23"
if not PACKAGE.exists():
    PACKAGE = Path("/Users/svbion/Projects/gpu-benchmark-lab/benchmarks/runpod/h200-sxm5/5-gpu-nv18/2026-07-23")
